...
def pressed():                          #function
        ...
        light1.changeColor(colors[notch])
        light1.setNotch((notch+1)%6)
        light2.changeColor(colors[(notch-1)%6])
        #light2.setNotch((notch+2)%6)
        light3.changeColor(colors[(notch-2)%6])
        #light3.setNotch((notch+3)%6)
